...
/** Close the modal that displays "not connected to board". */
Ardublockly.closeNotConnectedModal = function () {
  $('#not_running_dialog').closeModal();
};

/** Opens the modal that displays the "ports selection" canvas. 
 * created by @paulhenrique
 * 
*/
Ardublockly.openPortsSelection = function () {
  $('#port_selection_canvas_dialog').openModal({
    dismissible: true,
    opacity: .5,
    in_duration: 200,
    out_duration: 250
...
/** Close the modal that displays the "ports selection" canvas.
 * created by @paulhenrique
*/
Ardublockly.closePortsSelection = function () {
  $('#port_selection_canvas_dialog').closeModal();
};

/** Opens the modal that displays the "Explication Movie" canvas.
 * created by @paulhenrique
 * 
*/
Ardublockly.openMovieView = function () {
  $('#movie_dialog').openModal({
    dismissible: true,
    opacity: .5,
    in_duration: 200,
    out_duration: 250
...
/** Close the modal that displays the "Explication Movie" canvas.
 * created by @paulhenrique
*/
Ardublockly.closeMovieView = function () {
  $('#movie_dialog').closeModal();
};


/** Opens the modal that displays the "Information Text" canvas.
 * created by @paulhenrique
 * 
*/
Ardublockly.openInfo = function () {
  $('#info_dialog').openModal({
    dismissible: true,
    opacity: .5,
    in_duration: 200,
    out_duration: 250
...
/** Close the modal that displays the "Information Text" canvas.
 * created by @paulhenrique
*/
Ardublockly.closeInfo = function () {
  $('#info_dialog').closeModal();
};

/** Opens the modal that displays the "complete upload" message. 
 * created by @paulhenrique
*/
Ardublockly.openCompleteModal = function () {
  $('#complete_upload_dialog').openModal({
    dismissible: true,
    opacity: .5,
    in_duration: 200,
    out_duration: 250
 ...
 *  created by @paulhenrique
*/
Ardublockly.closeCompleteModal = function () {
  $('#complete_upload_dialog').closeModal();
};
